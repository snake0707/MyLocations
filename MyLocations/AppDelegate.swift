...
let MyManagedObjectContextSaveDidFailNotification = "MayManagedObjectContextSaveDidFailNotification"
...
//                println(storeURL)
            ...
            println("Could not find data model in app bundel")
        }
    ...
    func listenForFatalCoreDataNotifications() {
        NSNotificationCenter.defaultCenter().addObserverForName(MyManagedObjectContextSaveDidFailNotification, object: nil, queue: NSOperationQueue.mainQueue(), usingBlock: { notification in
            ...
            let alert = UIAlertController(title: "Internal Error", message: "There was a fatal error in the app an it connot continue.\n\n" + "Press OK to terminate the app. Sorry for the inconvenience.", preferredStyle: .Alert)
